...
namespace TafeEnrolment1
{
    public class Program
    {
        ...
        {
            int[] myArray1 = { 2, 18, 21, 3, 20, 17, 125, 23, 188, 34 };
            string[] myArray2 = { "Frog", "Cat", "Dog", "Elephant", "Zebra", "Koala" };
            ...
            Console.WriteLine("\n");
            Console.WriteLine("Student 1 compare to Student2");
            Console.WriteLine(student1.CompareTo(student2));
            Console.WriteLine("Student 1 compare to Student1");
            Console.WriteLine(student1.CompareTo(student1));
            Console.WriteLine("\n");
            Utility.BubbleSortAsc(myArray1);
            Console.WriteLine("numbers array sorted in ascending order using Bubble sort");
            foreach (var thing in myArray1)
            {
                Console.Write(thing + " ");
            }
            Console.WriteLine("\n");
            Utility.BubbleSortDes(myArray1);
            Console.WriteLine("numbers array sorted in descending order using Bubble sort");
            foreach (var thing in myArray1)
            {
                Console.Write(thing + " ");
            }
            Console.WriteLine("\n");
            Utility.BubbleSortAsc(myArray2);
            Console.WriteLine("words array sorted in ascending order using Bubble sort");
            foreach (var thing in myArray2)
            {
                Console.Write(thing + " ");
            }
            Console.WriteLine("\n");
            Utility.BubbleSortDes(myArray2);
            Console.WriteLine("words array sorted in descending order using Bubble sort");
            foreach (var thing in myArray2)
            {
                Console.Write(thing + " ");
            }
            ...
            Console.WriteLine("students array sorted in ascending order using Bubble sort");
            foreach (var thing in students)
            {
                Console.Write(thing + "\n ");
            }
            Console.ReadKey();
            ...
            Console.WriteLine("students array sorted in descending order using Bubble sort");
            foreach (var thing in students)
            {
                Console.Write(thing + "\n ");
            }
